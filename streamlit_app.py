...
def generate_llama2_response(prompt_input):
    ...
    (callminer logic i.e. "calling|called make payment|installment:2" which uses: 
    AND logic = Use a blank space as a separator or the word AND. // OR logic = Use a vertical bar (|) or the word OR. // 
    ...
    Distance Operators = Use a colon (:) followed by a numerical value (:2 or :2s)to specify a time frame in seconds for your search criteria for calls. //
